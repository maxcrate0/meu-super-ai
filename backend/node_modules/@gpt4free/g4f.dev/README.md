...
<p align="center">
  <img src="https://github.com/user-attachments/assets/7f60c240-00fa-4c37-bf7f-ae5cc20906a1" alt="GPT4Free logo" height="150" />
</p>

Built by [@xtekky](https://github.com/xtekky) — maintained by [@hlohaus](https://github.com/hlohaus)  
Support the project on GitHub Sponsors: https://github.com/sponsors/hlohaus ❤️
...
- GPT4Free supports local inference backends. See [docs/local.md](https://github.com/xtekky/gpt4free/blob/main/docs/local.md) for supported runtimes and hardware guidance.
- Media generation (image, audio, video) is supported through providers (e.g., Pollinations). See [docs/media.md](https://github.com/xtekky/gpt4free/blob/main/docs/media.md) for formats, options, and sample usage.

---

## Configuration & customization
- Configure via environment variables, CLI flags, or config files. See [docs/configuration.md](https://github.com/xtekky/gpt4free/blob/main/docs/configuration.md).
- To reduce install size, use partial requirement groups. See [docs/requirements.md](https://github.com/xtekky/gpt4free/blob/main/docs/requirements.md).
- Provider selection: learn how to set defaults and override per-request at [docs/selecting_a_provider.md](https://github.com/xtekky/gpt4free/blob/main/docs/selecting_a_provider.md).
...
- The web GUI is responsive and can be accessed from a phone by visiting your host IP:8080 or via a tunnel. See [docs/guides/phone.md](https://github.com/xtekky/gpt4free/blob/main/docs/guides/phone.md).
...
- Docs: [docs/interference-api.md](https://github.com/xtekky/gpt4free/blob/main/docs/interference-api.md)
...
- Streaming completions, stopping criteria, system messages, and tool-calling patterns are documented in:
  - [docs/client.md](https://github.com/xtekky/gpt4free/blob/main/docs/client.md)
  - [docs/requests.md](https://github.com/xtekky/gpt4free/blob/main/docs/requests.md)
- Integrations (LangChain, PydanticAI): [docs/pydantic_ai.md](https://github.com/xtekky/gpt4free/blob/main/docs/pydantic_ai.md)
- Legacy examples: [docs/legacy.md](https://github.com/xtekky/gpt4free/blob/main/docs/legacy.md)
...
- Read the guide: [docs/guides/create_provider.md](https://github.com/xtekky/gpt4free/blob/main/docs/guides/create_provider.md)
- Typical steps:
...
- See: [docs/guides/help_me.md](https://github.com/xtekky/gpt4free/blob/main/docs/guides/help_me.md) for prompt templates and workflows to accelerate development.
...
- For a full list of projects and sites using GPT4Free, see: [docs/powered-by.md](https://github.com/xtekky/gpt4free/blob/main/docs/powered-by.md)

...
import { 
  ...
  Layers, Database, Bot, Infinity, Languages, Home
} from 'lucide-react';
import { useLanguage } from '../i18n/LanguageContext';

const API = import.meta.env.VITE_API_URL || 'https://gemini-api-13003.azurewebsites.net';

export default function ChatHome({ user, setUser }) {
  ...
  const seoTexts = {
    pt: {
      title: 'jgspAI - Plataforma de Chat com Inteligência Artificial Avançada',
      description: 'Chat gratuito com GPT-4, Claude, Gemini, Llama e outros modelos de IA. Crie ferramentas personalizadas, execute código e muito mais.'
    },
    en: {
      title: 'jgspAI - Advanced Artificial Intelligence Chat Platform',
      description: 'Free chat with GPT-4, Claude, Gemini, Llama and other AI models. Create custom tools, execute code and much more.'
    }
  };
  const seo = seoTexts[lang] || seoTexts.pt;
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <link rel="canonical" href="https://jgsp.me/jgspai" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <div className="flex items-center space-x-8">
                <Link to="/jgspai" className="flex items-center space-x-2">
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between">
          <div className="flex items-center space-x-4 mb-4 md:mb-0">
            <Link to="/" className="flex items-center space-x-2 text-gray-400 hover:text-white transition-colors">
              ...
              <span className="text-sm">JGSP</span>
            </Link>
          ...
          <div className="flex items-center space-x-6 text-gray-400 text-sm">
            ...
            <Link to="/privacy" className="hover:text-white transition-colors">{lang === 'pt' ? 'Privacidade' : 'Privacy'}</Link>
            <Link to="/terms" className="hover:text-white transition-colors">{lang === 'pt' ? 'Termos' : 'Terms'}</Link>
